...
export const addOneMonthTodoData = (datas: CalendarDataType, todo: Tasks): CalendarDataType => {
  const restoredData = restoreTodoData(datas);
  const newData = setTodoData(restoredData, todo);
